            ...
            <thead>
                <tr>
                    ...
                    if ($permission_update && $permission_delete) {
                        ?>
                        <th>Edit/Delete</th>
                    <?php } elseif ($permission_update) {
                        ?>
                        <th>Edit</th>
                    <?php } elseif ($permission_delete) {
                        ?>
                        <th>Delete</th>
                    <?php } ?>
            ...
            <tbody>
                ...
                echo $id;
                    ?></td>
                        ...
                        <?php if ($permission_update && $permission_delete) { ?>
                        ...
                        elseif ($permission_delete) {
                            ...
                            <?php
                        } elseif ($permission_update) {
                            ?>
                            <td><button id="<?php echo $id . ":edit"; ?>" onclick="Edit('<?php echo $id; ?>')" type="button" class="btn btn-outline-info" data-bs-toggle="modal" data-bs-target="#editPompierModal"><img class="fit-picture" src="/img/edit_black_24dp.svg" alt="edit"></button></td>
                        <?php } ?>
                    </tr>
                    <?php
                }
